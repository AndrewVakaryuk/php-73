...
class BasicsTest extends TestCase
{
    ...
    public function testTypeJuggling()
    {
        ...
        $this->assertIsInt($foo);
        /*
        Test fails if '10 Little Piggies' is not casted to int
        "A non well formed numeric value encountered" - it says
        */

        $foo = 5 * (int)'10 Small Pigs';
        $this->assertIsInt($foo);
        //The same case as the previous assertion
    }
}